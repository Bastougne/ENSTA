...
class AgentPathogene {
  public:
    ...
    int nombreJoursAsymptomatique() { return int( m_generateur_symptomatique( m_moteur_stochastique ) ); }
    ...
    std::pair<int, int> periode_contagieux = {
        0, 2 }; // en jours : 1er chiffre apr_es contagion, second chiffre : apres symptomatique
    int nombre_jours_immunite =
        0; // Si different de zero, individus developpent une immunite pendant un certain nombre de jours
