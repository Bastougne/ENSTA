...
sdl2::texte::texte( const std::string &phrase, const font &fnt, window &win, const color &encre ) : image() {
    SDL_Color col;
    col.r = encre.red;
    col.b = encre.blue;
    col.g = encre.green;
    ...
    if ( this->pt_texture == nullptr ) {
        std::string errMsg = "Incapable de creer une texture du texte rendu : " + std::string( SDL_GetError() );
        throw std::runtime_error( errMsg );
    }
...
// =================================================================================================
sdl2::texte::texte( const std::string &phrase, const font &fnt, window &win, int maxwidth, int maxheight,
                    const color &encre, const color &papier, std::int32_t justification, int marge_width,
                    int marge_height )
    : image() {
    // Première etape, compter le nombre de lignes imposees (par des \n) et leur emplacement
...
// =================================================================================================
sdl2::texte::texte( const std::string &phrase, const font &fnt, window &win, int maxwidth, const color &encre,
                    const color &papier, std::int32_t justification, int marge_width, int marge_height )
    : image() {
    ...
    if ( pos_vert.back() < maxheight ) {
        panneau = SDL_CreateRGBSurface( SDL_SWSURFACE, maxwidth, pos_vert.back(), 32, 0, 0, 0, 0 );
    } else {
