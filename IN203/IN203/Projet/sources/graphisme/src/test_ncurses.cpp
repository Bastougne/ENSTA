...
int main( int nargs, char *argv[] ) {
    ...
    console.at( h - 2, 0 ) << ncurses::style(
                                  { ncurses::style::hightlighting, ncurses::style::bold, ncurses::style::underline } )
                           << "Veuillez bien regarder le message ci-dessous" << ncurses::endl;

    std::array all_names = { "block"s,
                             "board"s,
                             "bottom_tee"s,
                             "bullet"s,
                             "checker_board"s,
                             ...
                             "up_arrow"s,
                             "upper_left_corner"s,
                             "upper_right_corner"s,
                             "vertical_line"s };
    std::array all_symbols = { ncurses::symbol::block,
                               ncurses::symbol::board,
                               ncurses::symbol::bottom_tee,
                               ncurses::symbol::bullet,
                               ncurses::symbol::checker_board,
                               ncurses::symbol::down_arrow,
                               ncurses::symbol::degree,
                               ncurses::symbol::diamond,
                               ncurses::symbol::greater_or_equal,
                               ncurses::symbol::horizontal_line,
                               ncurses::symbol::lantern,
                               ncurses::symbol::left_arrow,
                               ncurses::symbol::lesser_or_equal,
                               ncurses::symbol::lower_left_corner,
                               ncurses::symbol::lower_right_corner,
                               ncurses::symbol::left_tee,
                               ncurses::symbol::not_equal,
                               ncurses::symbol::pi,
                               ncurses::symbol::plus_minus,
                               ncurses::symbol::plus,
                               ncurses::symbol::right_arrow,
                               ncurses::symbol::right_tee,
                               ncurses::symbol::scanline1,
                               ncurses::symbol::scanline3,
                               ncurses::symbol::scanline7,
                               ncurses::symbol::scanline9,
                               ncurses::symbol::sterling,
                               ncurses::symbol::top_tee,
                               ncurses::symbol::up_arrow,
                               ncurses::symbol::upper_left_corner,
                               ncurses::symbol::upper_right_corner,
                               ncurses::symbol::vertical_line };
