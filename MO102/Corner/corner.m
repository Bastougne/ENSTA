...
%   Curvature Properties¡±and submitted to IEEE Transaction on Image Processing. 
...
imwrite(marked_img,'.\Corner out\corner.jpg');
...
%   the extraction. The default gap size is 3 pixles.
...
for i=1:cur_num
    ...
    BW_edge(curve{i}(:,1)+curve{i}(:,2)*L)=1;
end
figure(1)
imshow(~BW_edge)
title('Edge map')
imwrite(~BW_edge,'.\Corner out\edge.jpg');
