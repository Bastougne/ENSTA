...
proc create_root_design { parentCell } {
  ...
  set m00_axi_init_axi_txn_2 [ create_bd_port -dir I m00_axi_init_axi_txn_2 ]
  set myClock [ create_bd_port -dir I -type clk myClock ]
  set myReset [ create_bd_port -dir I -type rst myReset ]
  ...
  # Create instance: myipAxi4_0, and set properties
  set myipAxi4_0 [ create_bd_cell -type ip -vlnv cea.fr:user:myipAxi4:1.0 myipAxi4_0 ]
  set_property -dict [ list \
   CONFIG.C_M00_AXI_BURST_LEN {8} \
   CONFIG.C_M00_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000000} \
 ] $myipAxi4_0

  # Create instance: myipAxi4_1, and set properties
  set myipAxi4_1 [ create_bd_cell -type ip -vlnv cea.fr:user:myipAxi4:1.0 myipAxi4_1 ]
  set_property -dict [ list \
   CONFIG.C_M00_AXI_BURST_LEN {32} \
   CONFIG.C_M00_AXI_TARGET_SLAVE_BASE_ADDR {0xC4000000} \
 ] $myipAxi4_1

  # Create instance: myipAxi4_2, and set properties
  set myipAxi4_2 [ create_bd_cell -type ip -vlnv cea.fr:user:myipAxi4:1.0 myipAxi4_2 ]
  set_property -dict [ list \
   CONFIG.C_M00_AXI_TARGET_SLAVE_BASE_ADDR {0xC2000000} \
 ] $myipAxi4_2
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_3_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_3/BRAM_PORTA] [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTB]
  connect_bd_intf_net -intf_net axi_bram_ctrl_4_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_4/BRAM_PORTA] [get_bd_intf_pins blk_mem_gen_1/BRAM_PORTB]
  ...
  connect_bd_intf_net -intf_net axi_crossbar_0_M01_AXI [get_bd_intf_pins axi_bram_ctrl_1/S_AXI] [get_bd_intf_pins axi_crossbar_0/M01_AXI]
  ...
  connect_bd_intf_net -intf_net myipAxi4_0_M00_AXI [get_bd_intf_pins axi_crossbar_0/S00_AXI] [get_bd_intf_pins myipAxi4_0/M00_AXI]
  connect_bd_intf_net -intf_net myipAxi4_1_M00_AXI [get_bd_intf_pins axi_crossbar_0/S02_AXI] [get_bd_intf_pins myipAxi4_1/M00_AXI]
  connect_bd_intf_net -intf_net myipAxi4_2_M00_AXI [get_bd_intf_pins axi_crossbar_0/S01_AXI] [get_bd_intf_pins myipAxi4_2/M00_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins axi_bram_ctrl_3/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_bram_ctrl_4/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins axi_bram_ctrl_5/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]

  # Create port connections
  connect_bd_net -net Net1 [get_bd_ports myReset] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_2/s_axi_aresetn] [get_bd_pins axi_crossbar_0/aresetn] [get_bd_pins myipAxi4_0/m00_axi_aresetn] [get_bd_pins myipAxi4_1/m00_axi_aresetn] [get_bd_pins myipAxi4_2/m00_axi_aresetn]
  connect_bd_net -net m00_axi_init_axi_txn_1_1 [get_bd_ports m00_axi_init_axi_txn_1] [get_bd_pins myipAxi4_1/m00_axi_init_axi_txn]
  connect_bd_net -net m00_axi_init_axi_txn_2_1 [get_bd_ports m00_axi_init_axi_txn_2] [get_bd_pins myipAxi4_2/m00_axi_init_axi_txn]
  connect_bd_net -net m00_axi_init_axi_txn_3 [get_bd_ports m00_axi_init_axi_txn] [get_bd_pins myipAxi4_0/m00_axi_init_axi_txn]
  connect_bd_net -net myClock_1 [get_bd_ports myClock] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_bram_ctrl_2/s_axi_aclk] [get_bd_pins axi_crossbar_0/aclk] [get_bd_pins myipAxi4_0/m00_axi_aclk] [get_bd_pins myipAxi4_1/m00_axi_aclk] [get_bd_pins myipAxi4_2/m00_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_3/s_axi_aclk] [get_bd_pins axi_bram_ctrl_4/s_axi_aclk] [get_bd_pins axi_bram_ctrl_5/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_3/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_4/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_5/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00002000 -offset 0xC0000000 [get_bd_addr_spaces myipAxi4_0/M00_AXI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00002000 -offset 0xC2000000 [get_bd_addr_spaces myipAxi4_0/M00_AXI] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
  create_bd_addr_seg -range 0x00002000 -offset 0xC4000000 [get_bd_addr_spaces myipAxi4_0/M00_AXI] [get_bd_addr_segs axi_bram_ctrl_2/S_AXI/Mem0] SEG_axi_bram_ctrl_2_Mem0
  create_bd_addr_seg -range 0x00002000 -offset 0xC0000000 [get_bd_addr_spaces myipAxi4_1/M00_AXI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00002000 -offset 0xC2000000 [get_bd_addr_spaces myipAxi4_1/M00_AXI] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
  create_bd_addr_seg -range 0x00002000 -offset 0xC4000000 [get_bd_addr_spaces myipAxi4_1/M00_AXI] [get_bd_addr_segs axi_bram_ctrl_2/S_AXI/Mem0] SEG_axi_bram_ctrl_2_Mem0
  create_bd_addr_seg -range 0x00002000 -offset 0xC0000000 [get_bd_addr_spaces myipAxi4_2/M00_AXI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00002000 -offset 0xC2000000 [get_bd_addr_spaces myipAxi4_2/M00_AXI] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
  create_bd_addr_seg -range 0x00002000 -offset 0xC4000000 [get_bd_addr_spaces myipAxi4_2/M00_AXI] [get_bd_addr_segs axi_bram_ctrl_2/S_AXI/Mem0] SEG_axi_bram_ctrl_2_Mem0
  create_bd_addr_seg -range 0x00002000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_3/S_AXI/Mem0] SEG_axi_bram_ctrl_3_Mem0
  create_bd_addr_seg -range 0x00002000 -offset 0x42000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_4/S_AXI/Mem0] SEG_axi_bram_ctrl_4_Mem0
  create_bd_addr_seg -range 0x00002000 -offset 0x44000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_5/S_AXI/Mem0] SEG_axi_bram_ctrl_5_Mem0
