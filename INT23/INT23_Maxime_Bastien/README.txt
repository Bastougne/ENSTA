...
La version précédente de rech_larg est obsolète, veuillez prendre celle présente dans cette archive en compte.

Les heuristiques fonctionnent si on les appelle à la main, mais l'appel par A* indique une erreur d'instanciation que nous ne sommes pas parvenus à résoudre.

Les relations nécessaires pour tester A* sur le TD3 se trouvent dans TD3.pl
